class Inventlist < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/inventlist/cli/releases/download/v0.1.4/inventlist_Darwin_arm64.tar.gz"
      sha256 "65bbe598ae1b0d338b34ed4ac64a03a657254cae11a84aca7b39e111a035278b"
    end
    on_intel do
      url "https://github.com/inventlist/cli/releases/download/v0.1.4/inventlist_Darwin_x86_64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/inventlist/cli/releases/download/v0.1.4/inventlist_Linux_arm64.tar.gz"
      sha256 "66bd60dc85fa9b771b536fb50e6025e3ab077883b5d5f0e2537a6d152d5589c1"
    end
    on_intel do
      url "https://github.com/inventlist/cli/releases/download/v0.1.4/inventlist_Linux_x86_64.tar.gz"
